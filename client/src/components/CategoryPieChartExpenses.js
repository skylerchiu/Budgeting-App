...
export const CategoryPieChartExpense = () => {
    ...
    var category_int = parseInt(category, 10);
    var amounts_int
  // Find the objects in the array with category value 1. Add them together
...
const transportation_amounts = rentArray.map(transaction => transaction.amount);
